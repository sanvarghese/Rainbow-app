...
export default function DashboardPage() {
    ...
    const handleConfirmSave = () => {
        ...
        setShowView('dashboard');
    };
    const handleBackToDashboard = () => setShowView('dashboard');
    ...
    if (showView === 'dashboard') {
        return <MerchantDashboardView onBackToPreview={() => setShowView('preview')} />;
    }
    ...
    return (
        <Container sx={{ py: 4 }}>
                                    ...
                                    <Box sx={{ display: 'flex', gap: 1 }}>
                                        {status?.company?.facebookLink && (
                                            <Chip
                                                label="Facebook"
                                                component="a"
                                                href={status.company.facebookLink}
                                                target="_blank"
                                                clickable
                                                size="small"
                                            />
                                        ...
                                        {status?.company?.instagramLink && (
                                            <Chip
                                                label="Instagram"
                                                component="a"
                                                href={status.company.instagramLink}
                                                target="_blank"
                                                clickable
                                                size="small"
                                            />
            ...
            <Paper elevation={3} sx={{ p: 4 }}>
                ...
                >
                    <Typography variant="h5">
                        Your Products ({status?.products?.length || 0})
                    </Typography>
                    {/* <Button variant="contained" onClick={handleAddProduct}>
                        + Add Product
                    </Button> */}

                    {/* <Button variant="outlined" startIcon={<EditIcon />} onClick={() => handleEditProduct(product)}>
                        Edit product
                    </Button> */}
                </Box>
                                ...
                                >
                                    ...
                                    <CardContent sx={{ flexGrow: 1 }}>
                                        ...
                                        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mb: 2 }}>
                                            ...
                                            {product.foodType && (
                                                <Chip
                                                    label={product.foodType}
                                                    size="small"
                                                    color={product.foodType === 'veg' ? 'success' : 'error'}
                                                />
                                            )}
                                        </Box>
            ...
            <Dialog open={showSaveDialog} onClose={() => setShowSaveDialog(false)}>
                ...
                <DialogContent>
                    <Typography>
                        Are you sure you want to save all changes and complete the setup? Your profile will be
