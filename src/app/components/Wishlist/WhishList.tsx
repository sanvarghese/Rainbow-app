...
export default function WishlistPage() {
  ...
  const getProductId = (item: WishlistItemType): string => {
    if (typeof item.productId === "object" && item.productId !== null) {
      return (item.productId as ProductType)._id;
    }
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex gap-2">
                  <button
                    ...
                    className="flex-1 text-white px-3 py-2 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
